 ...
 * @author chenxiaofan
 */
public class MultiThreadMultiConnectionSyncGet extends AbstractMultiThreadSync<byte[]> {

    static {
        logger = InternalLoggerFactory.getInstance(MultiThreadMultiConnectionSyncGet.class);
    }
    ...
    public static void main(String[] args) {
        runTest(new MultiThreadMultiConnectionSyncGet(), args);
    }
