 ...
 * @author chenxiaofan
 */
public class ClusterMultiThreadSyncSetGet extends AbstractClusterMultiThreadSync<byte[]> {

    static {
        logger = InternalLoggerFactory.getInstance(ClusterMultiThreadSyncSetGet.class);
    }
    ...
    public static void main(String[] args) {
        runTest(new ClusterMultiThreadSyncSetGet(), args);
    }
